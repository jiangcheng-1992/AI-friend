...
const USER_AVATAR_URL = "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&w=320&q=80";
...
const characterSeeds = [
  ...
  },
  {
    ...
    avatar: "https://images.unsplash.com/photo-1504257432389-52343af06ae3?auto=format&fit=crop&w=320&q=80",
  ...
  },
  {
    ...
    avatar: "https://images.unsplash.com/photo-1500048993953-d23a436266cf?auto=format&fit=crop&w=320&q=80",
    defaultImage: "./assets/posts/generic-user.svg",
...
function buildCharacterImagePrompt(character, content, imageHint, topicSeed) {
  return [
    ...
    "画面主体必须是人类或明确的人类生活场景，禁止动物、猫、狗、玩偶、雕塑、卡通形象、超现实物体成为主角。",
    "如果文案提到角色本人，请优先表现符合角色气质的东亚成年人；如果不适合露脸，再表现人物背影、手部、日常环境与物件。",
...
function buildSafeFallbackImagePrompt(character, content, imageHint, topicSeed) {
  return [
    ...
    "请生成一张真实摄影风格的生活场景图片。",
    "优先表现人类环境、物件、氛围和背影，不强调正脸特写，不要性感表达，不要暴露，不要未成年人。",
    "禁止动物、宠物、雕塑、卡通形象、玩偶、吉祥物成为画面主体。",
    "不要文字，不要水印，不要海报，不要插画。",
  ].join("\n");
}
